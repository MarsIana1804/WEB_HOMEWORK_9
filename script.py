...
def main():
    ...
    homework9_database = 'homework_9_01_mongo_db'

    connection_string = 'mongodb+srv://{}:{}@marsianka.rffwu2u.mongodb.net/{}?retryWrites=true&w=majority&appName=Marsianka'.format(username, password, homework9_database)
